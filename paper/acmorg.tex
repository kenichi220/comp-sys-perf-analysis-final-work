...
\label{sec:org6868e90}
\label{sec.context}
\subsection{Background}
\label{sec:org477e439}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=\linewidth]{/tmp/babel-HcMRav/figureMRkR8v.pdf}
\caption{\label{fig:org945a7f0}Mean of experimental results.}
\end{figure}


\subsection{The impact of node number and batch size}
\label{sec:org80af79f}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=\linewidth]{/tmp/babel-HcMRav/figureozVgfy.pdf}
\caption{\label{fig:org9f81cda}Mean of experimental results grouped by node count.}
\end{figure}


\begin{figure}[!htb]
\centering
\includegraphics[width=\linewidth]{/tmp/babel-HcMRav/figurelf9seS.pdf}
\caption{\label{fig:org6c5647c}Mean of experimental results grouped by batch size.}
\end{figure}


\subsection{Modeling a linear model}
\label{sec:org1e9e318}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=\linewidth]{/tmp/babel-HcMRav/figureUs11uQ.pdf}
\caption{\label{fig:org5893af5}Quadratic model}
\end{figure}


\begin{figure}[!htb]
\centering
\includegraphics[width=\linewidth]{/tmp/babel-HcMRav/figurek6Z7JN.pdf}
\caption{\label{fig:orgf1b989a}Linear Model}
\end{figure}

\section{Conclusion}
\label{sec:org615b2a9}
